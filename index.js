// shows relationship b/n space and time
// size of input vs time
function sum(array) {
    let sum = 0, ticks = 1;
...
// Constant Time O(1)
// the carrier pidgeon w/ the usb
// run time is ALWAYS the same no matter the size of the input
...
// run time increases with size of input but v slowy
// second best alg in regard to speed
...
// Linear Time O(n)
// run time directly correlates to size of input
...
// run time correlates to n (size of inputs) to the power of k (# of nested loops)
...
// algs that run time grow exponentially fast depending on size of input
//                   *
//                  * *
//                * * * *
//            * * * * * * * *
